...
# ---- load raw data ----
data_raw <- read_csv(file = 'C:/Users/radtk/OneDrive/Dokumente/Data_management_course/HOBO_exercises/01_data_raw/hobo/2022/raw/10347355.csv', skip = 1, col_names = T) 
...
write_csv(x=data, file = 'C:/Users/radtk/OneDrive/Dokumente/Data_management_course/HOBO_exercises/02_data_processed/10347355_cleannames.csv')
